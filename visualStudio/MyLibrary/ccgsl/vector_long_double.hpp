...
#ifndef CCGSL_VECTOR_LONG_DOUBLE_HPP
#define CCGSL_VECTOR_LONG_DOUBLE_HPP
...
#include"block_long_double.hpp"

// This file is autogenerated

namespace gsl {
  // declare matrix_long_double class
  class matrix_long_double;
  /**
   * This class handles vector_long_double objects as shared handles. It models a random access container
   * so that STL functions work with vector_long_double.
   *
  ...
  public:
     ...
     * @param n The number of elements in the vector_long_double
     */
    explicit vector_long_double( size_t const n ){
      ccgsl_pointer = gsl_vector_long_double_alloc( n );
      // just plausibly we could allocate vector_long_double but not count
      try { count = new size_t; } catch( std::bad_alloc& e ){
	// try to tidy up before rethrowing
	gsl_vector_long_double_free( ccgsl_pointer );
	throw e;
      }
      *count = 1; // initially there is just one reference to ccgsl_pointer
    }
    /**
     * Could construct from a gsl_vector_long_double. This is not usually a good idea. In this case
     * we should not use gsl_vector_long_double_free() to deallocate the memory.
     * @param v The vector_long_double
     */
    explicit vector_long_double( gsl_vector_long_double* v ){
      ccgsl_pointer = v;
    ...
    // copy constructor
    /**
     * The copy constructor. This shares the vector_long_double. Use clone() if you want a full copy.
     * @param v The vector_long_double to copy.
     */
    vector_long_double( vector_long_double const& v ) : ccgsl_pointer( v.ccgsl_pointer ), count( v.count ){
      ++*count; // vector_long_double is now shared.
    }
    // assignment operator
    /**
    ...
    vector_long_double& operator=( vector_long_double const& v ){
      ...
      if( --*count == 0 ){
	if( ccgsl_pointer != 0 ) gsl_vector_long_double_free( ccgsl_pointer );
	delete count;
      }
      // Then copy
    ...
    vector_long_double clone() const {
      vector_long_double copy( get()->size );
      // Now copy
      gsl_vector_long_double_memcpy( copy.get(), get() );
      // return new object
      return copy;
    }
    // destructor
     ...
     * @param v The vector_long_double to be compared with @c this
    ...
    bool operator==( vector_long_double const& v ) const {
      // trivially equal if gsl_vector_long_double*s are identical
  	...
  	if( gsl_vector_long_double_get( ccgsl_pointer, i ) != gsl_vector_long_double_get( v.ccgsl_pointer, i ) ) return false; 
      return true;
    }
    // != operator
    /**
     ...
     * identical elements or not
     */
    bool operator!=( vector_long_double const& v ) const { return not operator==( v ); }
     ...
     * for example, for checking, that a vector_long_double is nonnegative.
     * @param v The vector_long_double to be compared with @c this
     * @return @c false or @c true according as @c this is less than @c v
     * lexicographically
     */
    bool operator<( vector_long_double const& v ) const {
      // null vector_long_double comes first
	...
	long double const t = gsl_vector_long_double_get( ccgsl_pointer, i );
	long double const u =gsl_vector_long_double_get( v.ccgsl_pointer, i );
	if( t < u ) return true;
	if( u < t ) return false;
      }
      // elements match.
  ...
  private:
    ...
    class iterator_base
      ...
      friend class vector_long_double;
    public:
      // // type iterator_traits<vector_long_double>::difference_type
      /**
    ...
    public:
  	...
  	if( v == 0 ){
  	  ...
  	  gsl_error( "vector_long_double not initialised", __FILE__, __LINE__, exception::GSL_EFAILED );
  	  return something;
  	}
  	...
  	// Warn if iterators do not point to same vector_long_double
  	if( v->ccgsl_pointer != i.v->ccgsl_pointer ){
  	  gsl_error( "trying to take difference of iterators for different vector_long_double objects", __FILE__, __LINE__,
	...
	return not this->operator==( i );
       ...
       * if the iterators iterate over the same vector_long_double and the function calls
    ...
    protected:
       ...
       */
      void increment(){
  	// Only makes sense if v points to a vector_long_double
  	if( v == 0 ){
  	  gsl_error( "iterator not initialised", __FILE__, __LINE__, exception::GSL_EFAILED );
  	  return;
  	} else if( v->ccgsl_pointer == 0 ){
       ...
       * @param v The vector_long_double that creates @c this
     ...
     */
    template<bool reverse_t> class iterator_t : public iterator_base<vector_long_double,long double,reverse_t>{
    public:
  	...
  	iterator_base<vector_long_double,long double,reverse_t>::v = i.v;
  	iterator_base<vector_long_double,long double,reverse_t>::position = i.position;
  	return *this;
      }
  	...
  	iterator_base<vector_long_double,long double,reverse_t>::increment();
  	return *this;
      }
      /**
       ...
       */
      iterator_t<reverse_t>& operator--(){
  	iterator_base<vector_long_double,long double,reverse_t>::decrement();
  	return *this;
      }
      /**
       * The postfix -- operator.
       ...
       * Difference type.
       */
      typedef typename iterator_base<vector_long_double,long double,reverse_t>::difference_type
  	difference_type;
      // // operator+=
      /**
       * The += operator.
  	...
  	return iterator_base<vector_long_double,long double,reverse_t>::operator-( i );
      }
      /**
       * The - operator: find distance between two iterators
       ...
       */
      iterator_t<reverse_t>() : iterator_base<vector_long_double,long double,reverse_t>(){}
    protected:
      friend class vector_long_double;
      // We need a constructor for vector_long_double
      /**
       * This constructor allows vector_long_double to create non-default iterators.
       * @param v The vector_long_double that creates @c this
       * @param position The initial postion of the iterator
       */
      iterator_t<reverse_t>( vector_long_double* v, difference_type position )
      : iterator_base<vector_long_double,long double,reverse_t>( v, position ){}
    };
    /**
    ...
    public:
  	...
  	iterator_base<vector_long_double const,long double,reverse_t>::v = i.v;
  	iterator_base<vector_long_double const,long double,reverse_t>::position = i.position;
  	return *this;
      }
      // // Refines forward iterator
      // // operator++ (both)
  	...
  	iterator_base<vector_long_double const,long double,reverse_t>::increment();
  	return *this;
      }
      /**
       * The postfix ++ operator.
       ...
       */
      const_iterator_t<reverse_t>& operator--(){
  	iterator_base<vector_long_double const,long double,reverse_t>::decrement();
  	return *this;
      }
      /**
       * The postfix -- operator.
       ...
       * Difference type.
       */
      typedef typename iterator_base<vector_long_double const,long double,reverse_t>::difference_type
  	difference_type;
      // // operator+=
      /**
       * The += operator.
       ...
       */
      difference_type operator-( const_iterator_t<reverse_t> const& i ) const {
  	return iterator_base<vector_long_double const,long double,reverse_t>::operator-( i );
      }
      /**
       * The - operator: find distance between two iterators
       * @param i A second iterator
       ...
       * The default constructor.
       */
      const_iterator_t<reverse_t>() : iterator_base<vector_long_double,long double,reverse_t>(){}
      /**
       * A copy constructor
    ...
    protected:
       ...
       * @param position The initial postion of the iterator
       */
      const_iterator_t<reverse_t>( vector_long_double const* v, difference_type position )
      : iterator_base<vector_long_double const,long double,reverse_t>( v, position ){}
    };
  public:
    /**
     ...
     * @return iterator pointing to first vector_long_double element
     */
    iterator begin(){
     ...
     * @return iterator pointing beyond last vector_long_double element
     */
    iterator end(){
     ...
     * @return The size of the vector_long_double
     */
    size_type size() const { return ccgsl_pointer == 0 ? 0 : ccgsl_pointer->size; }
    // max_size()
    /**
     * The max size (number of elements) of the vector_long_double. Identical to
    ...
    /**
     * Swap two vector_long_double objects. This works even if the vector_long_double objects have different sizes
     * because it swaps pointers.
     * @param v The vector_long_double to swap with @c this.
     */
    void swap( vector_long_double& v ){
      gsl_vector_long_double* tmp = ccgsl_pointer; ccgsl_pointer = v.ccgsl_pointer; v.ccgsl_pointer = tmp;
    ...
    // rend()
    /**
     * Get iterator pointing beyon last vector_long_double element.
     * @return iterator pointing beyond last vector_long_double element
     */
     ...
     * @return a reference to a long double
     */
    long double& operator[]( size_t const n ){
      // Always try to return something
      static long double something = 0;
      // First check that iterator is initialised.
      if( ccgsl_pointer == 0 ){
  	gsl_error( "vector_long_double is null", __FILE__, __LINE__, exception::GSL_EFAILED );
  	return something;
      }
      // Check that position make sense
      if( n >= size() ){
  	gsl_error( "trying to read beyond end of vector_long_double", __FILE__, __LINE__, exception::GSL_EFAILED );
  	return something;
      }
  ...
  public:
     ...
     * @return the gsl_vector_long_double
     */
    ...
    gsl_vector_long_double const* get() const {
      ...
      return ccgsl_pointer; }
    /**
     * Find if @c this is the only object sharing the gsl_vector_long_double.
     * @return @c true or @c falses according as 
     * this is the only vector_long_double object sharing the gsl_vector_long_double
     */
    bool unique() const { return *count == 1; }
    /**
     * Find how many vector_long_double objects share this pointer.
     * @return the number of vector_long_double objects that share this pointer
     */
    size_t use_count() const { return *count; }
    /**
     * Allow conversion to bool.
     * @return @c true or @c false according as @c this contains a pointer
     * to a gsl_vector_long_double
     */
    operator bool() const { return ccgsl_pointer != 0; }

    // GSL functions
    /**
     * C++ version of gsl_vector_long_double_calloc(). This constructs a vector_long_double object with entries
     * initialised to zero.
     * @param n The size of the vector_long_double
     * @return A vector_long_double initialised to zero
     */
    static vector_long_double calloc( size_t const n ){ return vector_long_double( gsl_vector_long_double_calloc( n ) ); }
    /**
     * C++ version of gsl_vector_long_double_set_zero().
     */
    void set_zero(){ gsl_vector_long_double_set_zero( get() ); }
    /**
     * C++ version of gsl_vector_long_double_set_all().
     * @param x The value to which all elements are set
     */
    void set_all( long double x ){ gsl_vector_long_double_set_all( get(), x ); }
    /**
     * C++ version of gsl_vector_long_double_set_basis(). Creates a basis vector_long_double with one nonzero element.
     * @param i The element to be set to 1.
     * @return error code on failure
     */
    int set_basis( size_t i ){ return gsl_vector_long_double_set_basis( get(), i ); }
    /**
     * C++ version of gsl_vector_long_double_memcpy().
     * @param src source vector_long_double
     * @return error code on failure
     */
    int memcpy( vector_long_double const& src ){ return gsl_vector_long_double_memcpy( get(), src.get() ); }
    /**
     * C++ version of gsl_vector_long_double_reverse().
     * @return error code on failure
     */
    int reverse(){ return gsl_vector_long_double_reverse( get() ); }
    /**
    ...
    int swap_elements( size_t const i, size_t const j ){
      return gsl_vector_long_double_swap_elements( get(), i, j ); }
    /**
     * C++ version of gsl_vector_long_double_max().
     * @return maximum element of vector_long_double
     */
    long double max() const { return gsl_vector_long_double_max( get() ); }
    /**
     * C++ version of gsl_vector_long_double_min().
     * @return minimum element of vector_long_double
     */
    long double min() const { return gsl_vector_long_double_min( get() ); }
    /**
     * C++ version of gsl_vector_long_double_minmax().
     * @param min_out minimum element of vector_long_double
     * @param max_out maximum element of vector_long_double
     */
    void minmax( long double* min_out, long double* max_out ) const {
      gsl_vector_long_double_minmax( get(), min_out, max_out ); }
    /**
     * C++ version of gsl_vector_long_double_max_index().
     * @return index of maximum value of vector_long_double
     */
    size_t max_index() const { return gsl_vector_long_double_max_index( get() ); }
    /**
     * C++ version of gsl_vector_long_double_min_index().
     * @return index of minimum value of vector_long_double
     */
    size_t min_index() const { return gsl_vector_long_double_min_index( get() ); }
    /**
     * C++ version of gsl_vector_long_double_minmax_index().
     * @param imin index of minimum value of vector_long_double
     * @param imax index of maximum value of vector_long_double
     */
    void minmax_index( size_t* imin, size_t* imax ) const {
      gsl_vector_long_double_minmax_index( get(), imin, imax ); }
    /**
     * C++ version of gsl_vector_long_double_add().
     * @param b vector_long_double to add to @c this
     * @return error code on failure
     */
    int add( vector_long_double const& b ){ return gsl_vector_long_double_add( get(), b.get() ); }
    /**
     * C++ version of gsl_vector_long_double_sub().
     * @param b vector_long_double to subtract from @c this
     * @return error code on failure
     */
    int sub( vector_long_double const& b ){ return gsl_vector_long_double_sub( get(), b.get() ); }
    /**
     * C++ version of gsl_vector_long_double_mul().
     * @param b vector_long_double to multiply elementwise with @c this
     * @return error code on failure
     */
    int mul( vector_long_double const& b ){ return gsl_vector_long_double_mul( get(), b.get() ); }
    /**
     * C++ version of gsl_vector_long_double_div().
     * @param b vector_long_double to dividev @c this by elementwise
     * @return error code on failure
     */
    int div( vector_long_double const& b ){ return gsl_vector_long_double_div( get(), b.get() ); }
    /**
     * C++ version of gsl_vector_long_double_scale().
     * @param x constant to multiply @c this by
     * @return error code on failure
     */
    int scale( long double const x ){ return gsl_vector_long_double_scale( get(), x ); }
    /**
     * C++ version of gsl_vector_long_double_add_constant().
     * @param x constant to add to each element of @c this
     * @return error code on failure
     */
    int add_constant( long double const x ){ return gsl_vector_long_double_add_constant( get(), x ); }
    /**
     * C++ version of gsl_vector_long_double_isnull().
     * @return @c +1 or @c 0 according as elements are all zero or not
     */
    int isnull() const { return gsl_vector_long_double_isnull( get() ); }
    /**
     * C++ version of gsl_vector_long_double_ispos().
     * @return @c +1 or @c 0 according as elements are all positive or not
     */
    int ispos() const { return gsl_vector_long_double_ispos( get() ); }
    /**
     * C++ version of gsl_vector_long_double_isneg().
     * @return @c +1 or @c 0 according as elements are all negative or not
     */
    int isneg() const { return gsl_vector_long_double_isneg( get() ); }
    /**
     * C++ version of gsl_vector_long_double_isnonneg().
     * @return @c +1 or @c 0 according as elements are all nonnegative or not
     */
    int isnonneg() const { return gsl_vector_long_double_isnonneg( get() ); }
    /**
     * C++ version of gsl_vector_long_double_get().
     * @param i index of element to get
     * @return value of element
     */
    long double get( size_t const i ) const { return gsl_vector_long_double_get( get(), i ); }
    /**
     * C++ version of gsl_vector_long_double_set().
     * @param i index to set
     * @param x new value for element
     */
    void set( size_t const i, long double x ){ gsl_vector_long_double_set( get(), i, x ); }
    /**
     * C++ version of gsl_vector_long_double_ptr().
     * @param i index of element to get
     * @return pointer to element
     */
    long double* ptr( size_t const i ){ return gsl_vector_long_double_ptr( get(), i ); }
    /**
     * C++ version of gsl_vector_long_double_const_ptr().
     * @param i index of element to get
     * @return pointer to element
     */
    long double const* const_ptr( size_t const i ) const { return gsl_vector_long_double_const_ptr( get(), i ); }
    /**
     * C++ version of gsl_vector_long_double_fread().
     * @param stream A C file stream
     * @return error code on failure
     */
    int fread( FILE* stream ){ return gsl_vector_long_double_fread( stream, get() ); }
    /**
     * C++ version of gsl_vector_long_double_fwrite().
     * @param stream A C file stream
     * @return error code on failure
     */
    int fwrite( FILE* stream ) const { return gsl_vector_long_double_fwrite( stream, get() ); }
    /**
     * C++ version of gsl_vector_long_double_fscanf().
     * @param stream A C file stream
     * @return error code on failure
     */
    int fscanf( FILE* stream ){ return gsl_vector_long_double_fscanf( stream, get() ); }
    /**
    ...
    int fprintf( FILE* stream, char const* format ) const {
      return gsl_vector_long_double_fprintf( stream, get(), format ); }
    /**
     ...
     */
    vector_long_double( block_long_double& b, size_t const offset, size_t const n, size_t const stride ){
      ccgsl_pointer = gsl_vector_long_double_alloc_from_block( b.get(), offset, n, stride );
      // just plausibly we could allocate vector_long_double but not count
      try { count = new size_t; } catch( std::bad_alloc& e ){
	// try to tidy up before rethrowing
	gsl_vector_long_double_free( ccgsl_pointer );
     ...
     * @param stride The stride
     */
    vector_long_double( vector_long_double& v, size_t const offset, size_t const n, size_t const stride ){
      ccgsl_pointer = gsl_vector_long_double_alloc_from_vector( v.get(), offset, n, stride );
      // just plausibly we could allocate vector_long_double but not count
      try { count = new size_t; } catch( std::bad_alloc& e ){
	// try to tidy up before rethrowing
	gsl_vector_long_double_free( ccgsl_pointer );
    ...
    static vector_long_double view_array( long double* v, size_t n ){
      ...
      *w = gsl_vector_long_double_view_array( v, n ).vector;
    ...
    static vector_long_double view_array_with_stride( long double* base, size_t stride, size_t n ){
      gsl_vector_long_double* w = static_cast<gsl_vector_long_double*>( malloc( sizeof( gsl_vector_long_double ) ) );
      *w = gsl_vector_long_double_view_array_with_stride( base, stride, n ).vector;
      return vector_long_double( w );
    }
    /**
     * C++ version of gsl_vector_long_double_const_view_array().
     * @param v An array of type long double
     * @param n The size of the vector_long_double
     * @return A vector_long_double
     */
    static vector_long_double const const_view_array( long double const* v, size_t n ){
      gsl_vector_long_double* w = static_cast<gsl_vector_long_double*>( malloc( sizeof( gsl_vector_long_double ) ) );
      *w = gsl_vector_long_double_const_view_array( v, n ).vector;
      return vector_long_double( w );
    }
    /**
    ...
    static vector_long_double const const_view_array_with_stride( long double const* base, size_t stride, size_t n ){
      gsl_vector_long_double* w = static_cast<gsl_vector_long_double*>( malloc( sizeof( gsl_vector_long_double ) ) );
      *w = gsl_vector_long_double_const_view_array_with_stride( base, stride, n ).vector;
      return vector_long_double( w );
    }
    /**
    ...
    vector_long_double subvector( size_t i, size_t n ){
      gsl_vector_long_double* w = static_cast<gsl_vector_long_double*>( malloc( sizeof( gsl_vector_long_double ) ) );
      *w = gsl_vector_long_double_subvector( get(), i, n ).vector;
      return vector_long_double( w );
    }
    /**
    ...
    vector_long_double subvector_with_stride( size_t i, size_t stride, size_t n ){
      gsl_vector_long_double* w = static_cast<gsl_vector_long_double*>( malloc( sizeof( gsl_vector_long_double ) ) );
      *w = gsl_vector_long_double_subvector_with_stride( get(), i, stride, n ).vector;
      return vector_long_double( w );
    }
    /**
     * C++ version of gsl_vector_long_double_subvector_with_stride().
    ...
    vector_long_double const const_subvector( size_t i, size_t n ) const {
      gsl_vector_long_double* w = static_cast<gsl_vector_long_double*>( malloc( sizeof( gsl_vector_long_double ) ) );
      *w = gsl_vector_long_double_const_subvector( get(), i, n ).vector;
      return vector_long_double( w );
    }
    /**
     * C++ version of gsl_vector_long_double_subvector_with_stride().
    ...
    vector_long_double const const_subvector_with_stride( size_t i, size_t stride, size_t n ) const {
      gsl_vector_long_double* w = static_cast<gsl_vector_long_double*>( malloc( sizeof( gsl_vector_long_double ) ) );
      *w = gsl_vector_long_double_const_subvector_with_stride( get(), i, stride, n ).vector;
      return vector_long_double( w );
    }
    // Extra allocators from matrix_long_double objects. The definition must come after matrix_long_double.
    /**
     * C++ version of gsl_vector_long_double_alloc_row_from_matrix().
     * @param m A matrix_long_double
     * @param i A row
     * @return A vector_long_double
     */
   ...
   * @see vector_long_double::iterator::operator+()
   */
  inline vector_long_double::iterator operator+
  ( vector_long_double::iterator::difference_type const n, vector_long_double::iterator const& i ){ return i + n; }
   ...
   * @see vector_long_double::iterator::operator+()
   */
  inline vector_long_double::const_iterator operator+
  ( vector_long_double::const_iterator::difference_type const n, vector_long_double::const_iterator const& i ){ return i + n; }
   ...
   * @see vector_long_double::iterator::operator+()
   */
  inline vector_long_double::reverse_iterator operator+
  ( vector_long_double::reverse_iterator::difference_type const n, vector_long_double::reverse_iterator const& i ){
    return i + n; }
   ...
   * @see vector_long_double::iterator::operator+()
   */
  inline vector_long_double::const_reverse_iterator operator+
  ( vector_long_double::const_reverse_iterator::difference_type const n, vector_long_double::const_reverse_iterator const& i ){
    return i + n; }
