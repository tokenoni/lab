#ifndef __ANDORSIF_H__
#define __ANDORSIF_H__
...
//	struct TSubImage *position;
	...
	std::vector<unsigned long> subimage_offset;
	//unsigned long *time_stamps;
	std::vector<unsigned long> time_stamps;
