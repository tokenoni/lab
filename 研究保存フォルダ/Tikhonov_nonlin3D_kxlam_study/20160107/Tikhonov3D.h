...
public:
	...
	//	solve 
	bool solve(const double relativeError0, const double vError1, const double lam1Error, const double lam2Error);
...
private:
	bool updateFandVandLam
		(const double relativeError0, const double vError1, const double lam1Error, const double lam2Error);
	bool updateF
